...
//        DeviceInterface device;
        String dataComName = PropertiesService.getGlobalProperty("COM_DATA");

        if(Boolean.parseBoolean(PropertiesService.getGlobalProperty("sourceEmulate"))){
            ...
            SerialPortDevice device = new SerialPortDevice(dataComName, 921600);
            device.liteProtocol = true;
            device.setProtocol(unit);
        }
////         TODO: 21.01.2018 remove after full migrate to commlite
        ...
        String terminalComName = PropertiesService.getGlobalProperty("COM_COMMAND");

        SerialPortDevice terminal = new SerialPortDevice(terminalComName, 921600);
