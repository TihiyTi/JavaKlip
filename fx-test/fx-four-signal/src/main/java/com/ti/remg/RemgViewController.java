...
public class RemgViewController extends AbstractViewSignalConsumer<RemgSignalType> implements Initializable {
    ...
    public void addChartsToBox(){
        realTimeMultiChartConsumers = Stream.generate(()-> new RealTimeMultiChartConsumer(3, 2000, false))
                .limit(12)
                .toList();
        ...
        addTypedConsumerToMap(RemgSignalType.EMG2, realTimeMultiChartConsumers.get(1).listeners.get(0));
        addTypedConsumerToMap(RemgSignalType.EMG3, realTimeMultiChartConsumers.get(2).listeners.get(0));
        addTypedConsumerToMap(RemgSignalType.EMG4, realTimeMultiChartConsumers.get(3).listeners.get(0));
        addTypedConsumerToMap(RemgSignalType.EMG5, realTimeMultiChartConsumers.get(4).listeners.get(0));
        addTypedConsumerToMap(RemgSignalType.EMG6, realTimeMultiChartConsumers.get(5).listeners.get(0));
        addTypedConsumerToMap(RemgSignalType.EMG7, realTimeMultiChartConsumers.get(6).listeners.get(0));
        addTypedConsumerToMap(RemgSignalType.EMG8, realTimeMultiChartConsumers.get(7).listeners.get(0));
        addTypedConsumerToMap(RemgSignalType.EMG9, realTimeMultiChartConsumers.get(8).listeners.get(0));
        addTypedConsumerToMap(RemgSignalType.EMG10, realTimeMultiChartConsumers.get(9).listeners.get(0));
        addTypedConsumerToMap(RemgSignalType.EMG11, realTimeMultiChartConsumers.get(10).listeners.get(0));
        addTypedConsumerToMap(RemgSignalType.EMG12, realTimeMultiChartConsumers.get(11).listeners.get(0));
